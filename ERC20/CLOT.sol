...
contract Clothings is ERC20Interface{
    string public name = "Clothings";
    string public symbol = "CLOT";
...
contract BrandX is Clothings{
    address public admin;
    address payable public deposit;
    uint tokenPrice = 0.01 ether;  // 1 ETH = 100 CLOT, 1 CLOT = 0.01
